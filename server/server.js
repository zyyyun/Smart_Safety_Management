...
const sendStatusAlarmRouter = require('./send_status_alarm'); // ✅ 추가: 상태 알림 전송
...
const createGeofenceZoneRouter = require('./create_geofence_zone'); // ✅ 추가
const getGeofenceZonesRouter = require('./get_geofence_zones'); // ✅ 추가
const deleteGeofenceZoneRouter = require('./delete_geofence_zone'); // ✅ 추가
const updateGeofenceZoneRouter = require('./update_geofence_zone'); // ✅ 추가: 영역 수정
...
app.use('/', sendStatusAlarmRouter); // ✅ 추가
...
app.use('/', createGeofenceZoneRouter); // ✅ 추가
app.use('/', getGeofenceZonesRouter); // ✅ 추가
app.use('/', deleteGeofenceZoneRouter); // ✅ 추가
app.use('/', updateGeofenceZoneRouter); // ✅ 추가
