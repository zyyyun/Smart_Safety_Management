...
CREATE TABLE IF NOT EXISTS public.detection_events --감지된 이벤트 정보 테이블 정보로 게시글도 작성
(
...
(
    ...
    --역할 관리자-manager / 총괄관리자-general_manager / 근로자-worker
