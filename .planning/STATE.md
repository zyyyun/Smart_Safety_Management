...
Phase 9: ⚠ IN PROGRESS (2026-05-18) — TBM 현장 작업자 가이드 (TBM-01·02·03). CONTEXT + RESEARCH + PLAN + PLAN-CHECK 모두 완료 (`--auto` 모드).
  ...
  - 09-01·02·03·04-PLAN.md (커밋 98046f0): 4 plans / 3 waves.
    - Plan 01 Wave 1 (TBM-01, autonomous): 013_tbm_schema.sql + [BLOCKING] supabase db push + seed_tbm_demo.py + test_013_tbm_isolation.sql
    - Plan 02 Wave 2 (TBM-03, autonomous, ∥ Plan 03): notifications 4 case + deploy + 12 curl smoke
    - Plan 03 Wave 2 (TBM-02, autonomous, ∥ Plan 02): Android tbm/ 13 main + 4 TDD test + ComposeView 임베드 + compileDebugKotlin
  ...
  - 다음 = /gsd-execute-phase 9 (Wave 1 = Plan 01 부터, autonomous chain 가능). 마감일 없음, ROADMAP estimate 3일. 시연 흐름 (3·4·7·8 + 9) 통합 가능.
  - User Setup Required (Phase 8 와 동일 prerequisite): Vault `service_role_key` Dashboard 시드 — Plan 1 cron round-trip 검증 시점에만 필요. push 자체는 sr_key 부재여도 OK (graceful skip).
